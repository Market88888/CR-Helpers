...
function pcs_ver.fetch_changelog()
    local tmp = pcs_ver.tmpDir() .. "/PCStats_changelog.tmp"
    for _, name in ipairs({ "CHANGELOG.md", "changelog.md", "HISTORY.md" }) do
        for _, url in ipairs(pcs_ver.rawUrls(name)) do
            local ok = pcs_ver.fetch(url, tmp, 12)
            if ok then
                local body = pcs_ver.readAll(tmp)
                pcall(os.remove, tmp)
...
local ICON_FONT_FILE = CFG_DIR .. "/pcstats-icons-v4.ttf" -- v4: +33 glyphs (phone/heart/id-card/history/... were missing and drew as "?"); file name changes on every glyph-set change so the new font is re-extracted
local ICON_FONT_B64 = table.concat({
    "AAEAAAAKAIAAAwAgT1MvMlFNWmYAAAEoAAAAYGNtYXAcZhHgAAAC0AAAAmRnbHlmZ3PWoAAABdwAAErqaGVhZDJKigUAAACsAAAA",
    "NmhoZWEESAKDAAAA5AAAACRobXR4oLkBbQAAAYgAAAFIbG9jYcmytqoAAAU0AAAApm1heHAAYQD5AAABCAAAACBuYW1lBa4NkwAA",
    "UMgAAABacG9zdP/eABkAAFEkAAAAIAABAAADBQUArXJ7M18PPPUACwIAAAAAAObXIkQAAAAA5tciRP/5/7kCgAHHAAAACAACAAAA",
    "AAAAAAEAAAHM/7UAAAKA//n/+wKAAAEAAAAAAAAAAAAAAAAAAABSAAEAAABSAPgADgAAAAAAAQAAAAAAAAAAAAAAAAAAAAAABAH2",
    "A4QABQAAAUwBZgAAAEcBTAFmAAAA9QAZAIQAAAIACQMAAAAAAAAAAAAAEAAAAAAAAAAAAAAAQVdTTQCA8AL4HQHM/7UAAAHMAEsA",
    "AAABAAAAAAFCAbAAAAAgAAABgAAAAgAAAAIAAAACQAAUAcAAAAHAAAABgAAgAgAAEAIAAAwCQAAAAgAAAAIAABABwAAAAcAAAAHA",
    "AAABwAAAAgAAEAIAAAABQABAAgAAAAIAAAACAAAAAgAAAAIAAAABwAAAAYAAAAIAAAABwAAAAkD//gIA//sBwAAAAgAAIAIAAAAC",
    "AAAAAgD/+QKAABIBwAAAAgAACgIAABABwAAbAoAAAAHA//sCQAAAAkAAAAHAAAACAAAAAgD//QFAAAACAP/+AgAAAAIAAAACAAAA",
    "AcAAAAIAAAACgAAAAkAAAAHAAAACAAAQAgD/+wJAAAACAAAPAkAAAAKAAAACAAAAAkAAAAIAAAACAAAAAUAAAAIAAAABgAAAAgAA",
    "AAJAAAACQAAgAkD//gIAAAABwAAgAgD/+gIAAAABgAAAAfAAAAIAAAgCgAAUAAAAAQADAAEAAAAMAAQCWAAAAJIAgAAGABLwAvAF",
    "8AfwDfAR8BPwFfAX8CHwI/Ar8C3wMfA68ETwVfBY8FvwYPBi8GvwbvBx8HPwePCV8K7wwfDH8Mrw4vDn8O3w8/Ec8SDxJvEu8TXx",
    "U/Gw8djx2vHe8fjyAfI08sLyxvLn8vHzefOS86XzwfPt9MD1APUe9Tr1P/VS9VX1cfWQ9df1/fbT9tf23vfZ+B3//wAA8ALwBPAH",
    "8AzwEfAT8BXwF/Ah8CPwK/At8DHwOvBE8FTwV/Ba8GDwYvBr8G3wcfBz8HjwlfCt8MHwx/DK8OLw5/Dt8PPxHPEg8SbxLvE18VPx",
    "sPHY8drx3vH48gHyNPLC8sby5/Lx83nzkvOl88Hz7fTA9QD1HvU69T/1UvVU9XH1kPXX9f320/bX9t732fgd//8P/w/+D/0P+Q/2",
    "D/UP9A/zD+oP6Q/iD+EP3g/WD80Pvg+9D7wPuA+3D68Prg+sD6sPpw+LD3QPYg9dD1sPRA9ADzsPNg8ODwsPBg7/DvkO3A6ADlkO",
    "WA5VDjwONA4CDXUNiQ1RDUgM1wy/DJUMegxPC30LPgshCwYLAgrwCu8K1Aq2CnAKSwl2CXMJbQhzCDAAAQAAAAAAAAAAAAAAAAAA",
    "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
    "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAUQCkAN0BGAFeAYsBzQI+",
    "AtgDQQOHBCYEdAS0BSEFdAYJBoQGrwcDB1oHowgKCMgJAAk5CckKKQq2CwEL0wv9DDoMkw01DeIOPQ7RDzIPXw/AEA0RSRGREi0S",
    "0hM2E7EUWxSWFQgV7hY2FpIXAheVGBYYmBjpGTsZfxpBGsIblxwdHMMdTh3mHjse+R+PH/YgXyDaIT8h7yKMI0AjkSQYJNoldQAA",
    "AAUAAP/AAYABwAAGAA0AFAAbADUAADc3BzcnMREXMyMzJzEHNxcnFxExBzcjMyMXMTclNjcxMTY3ITEWFxYXETEGBwYHITEmJyYn",
    "EUBaWlpaJ7Ozs1pZgFlZWVkzs7OzWVr+5gENDhQBIBQODQEBDQ4U/uAUDg0BOoaGhob+9DqGhsCGhoYBDIbAhoYQFA4NAQENDhT+",
    "YBQODQEBDQ4UAaAAAAIAAP/AAgABwAAcADcAACUGBxcxFhUUBwYjIicnMQYHJicmJzY3NjcWFxYXBzI3MTE2NzY1NCcmJyYjIgcG",
    "BwYVFBcWFxYzAaABJ38JCQoNDQp+NUZYOzsCAjs7WFg7OwLQJyEhFBMTFCEhJychIRQTExQhISfwRjV+Cg0NCgkJfycBAjs7WFg7",
    "OwICOztYkBMTIiImJiIiExMTEyIiJiYiIhMTAAABAAD/4AIAAZkAJQAANxcnFxYzMjc3MTY3NTEmJyYnJgcGBwcxJzEmJyYHBgcG",
    "BxUxFhcwtLS0DBAQDLQvAQEhITQjISAZDAwZICEjNCEhAQEvlKmpqQsLqSxBBjYmJwoFCgoZDAwZCgoFCicmNgZBLAABABT/uwIs",
    "AcAAJwAAASYnBgcHMQcxBgcGFxcxBzEGFxY3NzEXMRY3NicnMTcxNicmJycxJwE9CRQTCkCQEwYGDmgZAg8QEoCBERAQAxhoDQUH",
    "E5BAAa4RAQERhBYDEhMOZ5ITDAsJREQJCwwTkmcOExIDFoQAAgAA/8ABwAHAABoAMAAANzI3MTE2NzY1NCcmJyYjIgcGBwYVFBcW",
    "FxYzBwYHMTEGBxQXFjMhMTI3NjUmJyYnI+AjHR0SERESHR0jIx0dEhEREh0dIy5LMzICCQgNAYQNCAkCMjNLXMARER4eIiIeHhER",
    "EREeHiIiHh4RETACMjNLDQgJCQgNSzMyAgABAAAAIAHAAWAAHgAAARYVMTEUBwExBiMiJycxJjU0NzYzMhcXMTcxNjMyFwG3CQn/",
    "AAoNDQqACQkKDQ0KaekKDQ0KAVcKDQ0K/wAJCYAKDQ0KCQlq6gkJAAABACAAIAFgAWAAMQAAATY1MTE0JyYjIgcHMScxJiMiBwYV",
    "FBcXMQcxBhUUFxYzMjc3MRcxFjMyNzY1NCcnMTcBVwkJCg0NCmlpCg0NCgkJamoJCQoNDQppaQoNDQoJCWpqASkKDQ0KCQlqagkJ",
    "Cg0NCmlpCg0NCgkJamoJCQoNDQppaQACABD/0AHwAcAAFQBMAAABNCcxMSYjIgcGFRUxFBcWMzI3NjU1BzY3MTE2JyYnJgcGBwYV",
    "FhcWFxYXNjc2NzY3NCcmJyYHBgcGFxYXFhcWFQYHBgcmJyYnNDc2NwEgCQkODgkJCQkODgkJkAoBAQgJDQ0KKRcXASAgNjZDQzY2",
    "ICABFxgoCg0NCQgBAQoeERECMjFLSzIxAhERHQGgDgkJCQkO4A4JCQkJDuBZCQ0NCgsBAQgiLzA4QzY2ICABASAgNjZDODAvIggB",
    "AQoLDQ0JGCMjKUsxMgICMjFLKSMjGAAAAgAM/8AB9AHAAGAAbQAAARYHBzEWFRQHFzEWBwYHBzEGBwYnJzEGBwcxBgcGIyInJicn",
    "MSYnBzEGJyYnJzEmJyY3NzEmNTQ3JzEmNzY3NzE2NzYXFzE2NzcxNjc2MzIXFhcXMRYXNzE2FxYXFzEWFwc2NzYnJicGBwYXFhcB",
    "8AQKLAICLAoEBwkFCgwKDjgUGAwEDxQWFhUOBAwYFDgOCg0JBQkHBAosAgIsCgQHCQUJDQoOOBQYDAQPFBYWFQ4EDBgUOA4KDQoE",
    "CQfwLRgWFhgtLRgWFhgtARkOCigMDQ0MKAoOEhEIEA8LBBIQCToOAwQEAw46CRASBAsPEAgREQ8KJw0NDQwoCg4SEQgQDwsEEhAK",
    "OQ4DBAQDDjkKEBIECw8QCBESqQEnKCgnAQEnKCgnAQABAAD/wAJBAcEAWgAAJQYHMTEGByMxFzEGFRUxFAcGIyMxIiMiKwIiJyY1",
    "NTE1MTQnJiMjMSIHBhUVMRUxFAcGKwIiIyIjIiMjMSInJjU1MTQ1NTEjMSYnJjU0NyUxNhcyFwUxFgcCQAEJCQ0gAQEMCxEQAgEC",
    "AiEYEQsMCQkOQA4JCQwLERggAQEBAQICEBELDCAOCQkKAQALCwwJAQAMAcANCQkBoAQEEBELDAwLERhADgkJCQkOQBgRCwwMCxFw",
    "AQJFAQkJDQ4K4AkBB+EKDgACAAD/wAIAAcAAGgAuAAABFhcxMRYXFhUUBwYHBgcmJyYnJjU0NzY3NjcHFTUVFBcXMRY3NicnMTUx",
    "JicGBwEARjo6JCIiJDo6RkY6OiQiIiQ6OkYYC2ATDgsSVQIWFgIBwAEhIjw9Q0M9PCIhAQEhIjw9Q0M9PCIhAXiIiIgNB0ALEhMO",
    "OXsWAgIWAAIAEP/ZAfABpwA8AH8AADc2NzYzMhcXMSMxIgcGFRQXFjMzMTAxMDkCMjc2NTUxNCcmIyIHBhUVMScxJicmBwYHBgcG",
    "FxYXFjc2NwcGBwYHFAcUFRUxFBcWMzI3NjU1MRc5AhYXFjc2NzY3NicmJyYHBgcGBwYjIicxMScxMzEyNzY1NCcmIyMxIiMGI2kM",
    "GjFAQDERIg4JCQkJDnAOCQkJCQ4OCQkSLDk5OTksJRAEBQYMDQwLBUIIBgYCAQkJDg4JCRIsOTk5OSwlEAQFBgwNDAsFDBoxQEAx",
    "ESIOCQkJCQ5wAgIDAvUiGi8vEQkJDg4JCQkJDnAOCQkJCQ4jESwPDg4PLCUuDQwLBQQFBgxWAwYGCAECAwJwDgkJCQkOIxEsDw4O",
    "DywlLg0MCwUEBQYMIhovLxEJCQ4OCQkBAAIAAP/AAcABwAAPADYAABMVNRUzMTUxJicmJwYHBgcHNRU1Njc2NxYXFhcVMTMxFhcW",
    "FxUxBgcGByExJicmJzUxNjc2NzOQoAEWFyIiFxYBQAIoKT09KSgCEBsSEgEBEhIb/sAbEhIBARISGxABMDAwMDAiFxYBARYXIjAw",
    "MDA9KSgCAigpPTABEhIbwBsSEgEBEhIbwBsSEgEAAAIAAP/qAbUBoAAbAC4AABEVNRUUFxcxFjMyNzcxNjU0JycxJiMjMQYHBgcX",
    "MhcxMRYVFAcGIyInJjU0NzYzE7ATGhkUhhISsBMblRQODQFwDgkJCQkODgkJCQkOAXCWlpYaE7ATE4YTGhkUsBMBDQ4UIAkJDg4J",
    "CQkJDg4JCQAABAAA/8ABwAHAACMAMwBAAE4AABMGBzExBgcRMRYXFhchMzI3NjU0JyYjNTEyNzY1ETE0JyYjIwEpAhUxITEiJyY1",
    "NDc2Mzc2NzMxFhcGByMxJicXMyMzFhcGByMxJic2N2ApGxsBARsbKQEgIA4JCQkJDg4JCQkJDiD+4AEA/wABAP8ADgkJCQkOIAEP",
    "wA8BAQ/ADwEQwMDADwEBD8APAQEPAcABGxsp/sApGxsBCQkODgkJQAkJDgFADgkJ/oBACQkODgkJ8A8BAQ8PAQEPMAEPDwEBDw8B",
    "AAACAAD/4AHAAaAAOQBAAAATJicGBwMxIzEiBwYVFBcWMzMxMjc2NTQnJiMjMTcxMzEXMSMxIgcGFRQXFjMzMTI3NjU0JyYjIzED",
    "FyMzIzcxF/4JFRUJiBoOCQkJCQ5gDgkJCQkOAhKgEgIOCQkJCQ5gDgkJCQkOGogacHBwODgBixQBART+lQkJDg4JCQkJDg4JCTAw",
    "CQkODgkJCQkODgkJAWv7lZUABgAQ//ACAAGQAA8AJQA7AFEAYwBzAAATBgcVMRYXMzE2NzUxJicjFyIHMTEGFRQXFjMhMTI3NjU0",
    "JyYjIRUiBzExBhUUFxYzITEyNzY1NCcmIyEVIgcxMQYVFBcWMyExMjc2NTQnJiMhJxU1FRYXMzE2NzUxJicjMQYHFwYHFTEWFzMx",
    "Njc1MSYnIygWAgIWMBYCAhYwmA4JCQkJDgEgDgkJCQkO/uAOCQkJCQ4BIA4JCQkJDv7gDgkJCQkOASAOCQkJCQ7+4LACFjAWAgIW",
    "MBYCGBYCAhYwFgICFjABkAIWMBYCAhYwFgIQCQkODgkJCQkODgkJoAkJDg4JCQkJDg4JCaAJCQ4OCQkJCQ4OCQmYMDAwFgICFjAW",
    "AgIWiAIWMBYCAhYwFgIAAAMAAP/AAfsBuwARACMAXQAAASYjMTEiBwcxFzE3MTY1NCcnBQYHBzEGFxY3NzE2NzcxJzEHJwYHMTEG",
    "BxExFhcWFyExNjc2NzUxNCcmIyIHBhUVMRQHBiMhMSInJjURMTQ3NjMzMTI3NjU0JyYjIwHYEhYWEh5iHhEREv7UCQQeBAoLDlkM",
    "CahiqEwpGxsBARsbKQEAKRsbAQkJDg4JCQkJDv8ADgkJCQkOYA4JCQkJDmABqhERHmIeEhYWEhLcCQ1YDgsKBB4ECahiqLIBGxsp",
    "/wApGxsBARsbKWAOCQkJCQ5gDgkJCQkOAQAOCQkJCQ4OCQkAAAEAQP/gAUABoAAdAAAlFhUxMRQHBzEGIyInJjU0NzcxJzEmNTQ3",
    "NjMyFxcBNwkJwAoNDQoJCaqqCQkKDQ0KwNcKDQ0KwAkJCg0NCqmpCg0NCgkJwAAAAgAA/8ACAAHAABoAPAAABTY3MTE2NzY1NCcm",
    "JyYnBgcGBwYVFBcWFxYXJzUVNSMxJic2NzMxNTE2NxYXFTEzMRYXBgcjMRUxBgcmJwEARjo6JCIiJDo6RkY6OiQiIiQ6OkYYQBYC",
    "AhZAAhYWAkAWAgIWQAIWFgJAASEiPD1DQz08IiEBASEiPD1DQz08IiEBqEBAQAIWFgJAFgICFkACFhYCQBYCAhYAAgAA/8ACAAHA",
    "ABoAOwAABTY3MTE2NzY1NCcmJyYnBgcGBwYVFBcWFxYXAzYXFzE3MTYXFgcHMRcxFgcGJycxBzEGJyY3NzEnMSY3AQBGOjokIiIk",
    "OjpGRjo6JCIiJDo6RlERES8vEREODi8vDg4RES8vEREODi8vDg5AASEiPD1DQz08IiEBASEiPD1DQz08IiEBAVEODi8vDg4RES8v",
    "EREODi8vDg4RES8vEREAAgAA/8ACAAHAABoALgAABTY3MTE2NzY1NCcmJyYnBgcGBwYVFBcWFxYXEwc3BwYnJzEmNzYXFzE3MTYX",
    "FgcBAEY6OiQiIiQ6OkZGOjokIiIkOjpGcYCAgBERQA4OEREvbxERDg5AASEiPD1DQz08IiEBASEiPD1DQz08IiEBAS+AgIAODkAR",
    "EQ4OL28ODhERAAADAAD/wAIAAcAAGgA4AEsAAAU2NzExNjc2NTQnJicmJwYHBgcGFRQXFhcWFyczIzM1MSMxJic2NzMxFhcVMTMx",
    "FhcGByMxJic2NzcyFzExFhUUBwYjIicmNTQ3NjMBAEY6OiQiIiQ6OkZGOjokIiIkOjpGKBgYGBgWAgIWMBYCCBYCAhZQFgICFigO",
    "CQkJCQ4OCQkJCQ5AASEiPD1DQz08IiEBASEiPD1DQz08IiEBsEACFhYCAhZYAhYWAgIWFgLQCQkODgkJCQkODgkJAAMAAP/AAgAB",
    "wABCAIQAlwAAATIXMTEWFRUxFhcWFzMxMhcWFRQHBiMjMQYHBgcVMRQHBiMiJyY1NTEmJyYnIzEiJyY1NDc2MzMxNjc2NzUxNDc2",
    "MwMWFzExFhc1MTQ3NjMyFxYVFTE2NzY3IzEiJyY1NDc2MzMxJicmJxUxFAcGIyInJjU1MQYHBgczMTIXFhUUBwYjIzcyFzExFhUU",
    "BwYjIicmNTQ3NjMBAA4JCUgxMQwKDgkJCQkOCgwxMkcJCQ4OCQlIMTEMCg4JCQkJDgoMMTFICQkOlQogHywJCQ4OCQksHyAKFQ4J",
    "CQkJDhUKIB8sCQkODgkJLB8gChUOCQkJCQ4VlQ4JCQkJDg4JCQkJDgHACQkOCgwxMkcJCQ4OCQlIMTEMCg4JCQkJDgoMMTFICQkO",
    "DgkJSDExDAoOCQn+4CwfIAoVDgkJCQkOFQogHywJCQ4OCQksHyAKFQ4JCQkJDhUKIB8sCQkODgkJQAkJDg4JCQkJDg4JCQAAAQAA",
    "AAABwAGAACkAADcGFTExFBcXMRYzMjc2NTQnJzEhMTI3NjU0JyYjITE3MTY1NCcmIyIHBwkJCaAKDQ0KCQlqATMOCQkJCQ7+zWoJ",
    "CQoNDQqg1woNDQqgCQkKDQ0KaQkJDg4JCWkKDQ0KCQmgAAEAAP/gAYABoAApAAATJiMxMSIHBzEGFRQXFjMyNzcxETEUFxYzMjc2",
    "NRExFzEWMzI3NjU0JyfXCg0NCqAJCQoNDQppCQkODgkJaQoNDQoJCaABlwkJoAoNDQoJCWr+zQ4JCQkJDgEzagkJCg0NCqAAAAUA",
    "AP/AAgABwAARAEQAVwBkAHEAABMXJxcjIyInJjU0NzYzMzEWFwcUFyMxIgcGFRUxFBcWMyExMjc2NTUxNCcmIyMxNjUmJyYnIzEG",
    "BwcxJzEmJyMxBgcGByEUBzExBisCNzE2NzMxMhcWFQUVNRUWFxYXMzE1MSMFMyMzNjc2NzUxIzEVvyIiIgFIEQsMDAsRAhgNfwoq",
    "DgkJCQkOAcAOCQkJCQ4qCgEZGSUCMxsYGBszAiUZGQEBUAwLEUgBIwwYAhELDP6QAQ0OFJDAAQCQkJAUDg0BwAF7Ozs7DAsREQsM",
    "ARQTFhIJCQ5ADgkJCQkOQA4JCRIWJRkZAQIqKikrAgEZGSURCww7FAEMCxHIsLCwFA4NAeDgAQ0OFLDgAAIAAP/AAcABxgAgADsA",
    "ABM2FxYXNjc2FxYXFhcWFxYVBgcGBwYHJicmJyYnNjc2NxMyNzY3NicmBwcxBicmJyYnJgcGBwYVFhcWM58ODiklEBUODhoVFg8Q",
    "CQkBHR4zMj8/MzIeHQECKytHQyUgHwgHEgoNGQ0MDRISDgwMGgwNASAgMQG7CwwmLhcUDAwZHx4gHx0dF0A1NSAgAQEgIDU1QDxI",
    "SUP+ZRUXJiUkDgwdCwwQFxcRDAsgFxcWNBwdAAP//v/gAkMBoAAmAEEAXgAAAQYHMTEGBwYHBgcGFxYXFhcWFxYXNjc2NzY3Njc2",
    "JyYnJicmJyYnBzQ3MTE2NzYzMhcWFxYVFAcGBwYjIicmJyY1NwYHMTEGByInJgcUFxYXFjc2NzYnJicmJwYXFhUBID0wMCQjFxcL",
    "BQULFxcjJDAwPT0wMCQjFxcMBQUMFxcjJDAwPZATEyIiJiYiIhMTExMiIiYmIiITE5ABEhIbCwkKAgMMISEoJxMTCQkYGR8JAgMB",
    "oAEXFyIhIyMcDAwcIyMhIhcXAQEXFyIhIyMcDAwcIyMhIhcXAeAnISEUExMUISEnJyEhFBMTFCEhJ0AbEhIBAwIJCgsnExMJDCEh",
    "KB8TEwICCgkLAAP/+//gAgUBoAASAB8AMgAAARYXEzEWBwYHITEmJyY3EzE2NxUGBxUxFhc2NzUxJicXNCcxMSYjIgcGFRQXFjMy",
    "NzY1AQAXDNgKCgwX/lAXDAoK2QwWFgICFhYCAhYgCQkODgkJCQkODgkJAaABE/6QFBQTAQETFBQBcBMBgAIWcBYCAhZwFgLgDgkJ",
    "CQkODgkJCQkOAAgAAP/AAcABwAAuAD8AUQBjAHMAhQCVAKcAABMyFzExFhUVMTMxNTE0NzYzMhcWFRUxMzEWFxYXFTEhMTUxNjc2",
    "NzMxNTE0NzYzBykCETEGBwYHITEmJyYnERcVNRUWFzMxNjc1MSYnIzEGBzMVNRUWFzMxNjc1MSYnIzEGBzcGBxUxFhczMTY3NTEm",
    "JyMFFTUVFhczMTY3NTEmJyMxBgc3BgcVMRYXMzE2NzUxJicjFxU1FRYXMzE2NzUxJicjMQYHgA4JCYAJCQ4OCQkwFA4NAf5AAQ0O",
    "FDAJCQ6AAcD+QAHAAQ0OFP6gFA4NAUABDyAPAQEPIA8BgAEPIA8BAQ8gDwGQDwEBDyAPAQEPIP7wAQ8gDwEBDyAPAZAPAQEPIA8B",
    "AQ8gcAEPIA8BAQ8gDwEBwAkJDiAgDgkJCQkOIAENDhQwMBQODQEgDgkJwP7wFA4NAQENDhQBEFAgICAPAQEPIA8BAQ8gICAPAQEP",
    "IA8BAQ8QAQ8gDwEBDyAPAZAgICAPAQEPIA8BAQ8QAQ8gDwEBDyAPARAgICAPAQEPIA8BAQ8AAAEAIAAgAeABIAAdAAA3FjMxMTI3",
    "NzE2NTQnJiMiBwcxJzEmIyIHBhUUFxfpCg0NCsAJCQoNDQqpqQoNDQoJCcApCQnACg0NCgkJqqoJCQoNDQrAAAEAAP/AAgIBwgAn",
    "AAATJicxMSYHBzEGBxYXFhcWFzY3NzE2JyYnJzEmBwcxJicmJzcxNicnpQYNDg9YGwIBPDxlZX0dChgDBgYPYBsTKDUqKRkxFQko",
    "AacPBgYDGAodfWVlPDwBAhtYDw4NBigJFTEZKSo1KBMbYAAAAgAA/8ACAAHAADQAPQAAJTY3MTE2NzQnJicmBwcxBiMjMSYnNTE0",
    "NzcxNicmJyYjBgcGBxQXBzEGFRYXFhcyNzcxFjMFFhcGByYnNjcBYEQtLQIGAwgHBk0FBzkPAQVNBQECCBUXRC0tAgq2FAETEx0c",
    "FLYZHf7wFgICFhYCAhaAAi0tRBcVCAIBBkwFAQ85BwVNBgcIAwYCLS1EHRq1FBwdExMBFLUJWAIWFgICFhYCAAb/+f/wAgABpwAU",
    "ACkAQABXAG4AewAAExYHBzEGIyInJzEmNzYXFzE3MTYXFRYHBzEGIyInJzEmNzYXFzE3MTYXNzQ3MTE2MzMxMhcWFRQHBiMjMSIn",
    "JjUVNDcxMTYzMzEyFxYVFAcGIyMxIicmNQc0NzExNjMhMTIXFhUUBwYjITEiJyY1JxYXFgcGByYnJjc2N5gPDUgHCgsHKA4OEREW",
    "NxASDw1IBwoLBygODhERFjcQEkgJCQ7gDgkJCQkO4A4JCQkJDuAOCQkJCQ7gDgkJQAkJDgEgDgkJCQkO/uAOCQlwGw8MDA8bGw8M",
    "DA8bAZoQElAIBygREQ4OFj0PDaAQElAIBygREQ4OFj0PDWYOCQkJCQ4OCQkJCQ6gDgkJCQkODgkJCQkOoA4JCQkJDg4JCQkJDjAB",
    "FxgYFwEBFxgYFwEAAAIAEv/RAm4BrwA9AHsAACU2NTExNCcmJyYHBzEGBwYXFhcWNzcxNhcWFxYVFAcHMQYjIicmJyY3NzE2JyYn",
    "JgcGBwcxBhcWFxYzMjc3JQYVMTEUFxYXFjc3MTY3NicmJyYHBzEGJyYnJjU0NzcxNjMyFxYXFgcHMQYXFhcWNzY3NzE2JyYnJiMi",
    "BwcCRCoqJzQzLAILAgIICAwNCwIZHB0WFxdxGSAgGRUCAhEBBwICCwsMDQgBHwQEJi05Oi1w/fgqKic0My0BCwICBwkMDQsCGRwd",
    "FhcYcBkgIBkVAgIRAQcCAgsLDA0IAR8EBCYtOToscbQtOjktJQUEHwEIDQwMCgIDCAERAgIVGSAhGHEXFxYdHBkCCwwNCAgCAgsC",
    "LDQzJyoqcBgtOjktJQUEHwEIDQwMCgIDCAERAgIVGSAhGHEXFxYdHBkCCw0MCAgCAgsCLDQzJyoqcAADAAD/4AHAAaAAGwA1AEIA",
    "ABMGBzExBgcRMRYXFhchMTY3Njc1MTQnJzEmIyMVNDcxMTYzMzEyFxYVFTEUBwYjIzEiJyY1NRcWFxYHBgcmJyY3NjdAGxISAQES",
    "EhsBQBsSEgETTRMa8wkJDsAOCQkJCQ7ADgkJoCQTEhITJCQTEhITJAGgARISG/7AGxISAQESEhvzGhNNE2AOCQkJCQ5ADgkJCQkO",
    "QKABHyAgHwEBHyAgHwEAAAYACv/wAgABkAAMACIAOABOAFsAaAAAEzY3NicmJwYHBhcWFzciBzExBhUUFxYzITEyNzY1NCcmIyEV",
    "IgcxMQYVFBcWMyExMjc2NTQnJiMhFSIHMTEGFRQXFjMhMTI3NjU0JyYjIQc2NzYnJicGBwYXFhc3JicmBwYHFhcWNzY3QBsPDAwP",
    "GxsPDAwPG4AOCQkJCQ4BIA4JCQkJDv7gDgkJCQkOASAOCQkJCQ7+4A4JCQkJDgEgDgkJCQkO/uCAGw8MDA8bGw8MDA8bMAEXGBgX",
    "AQEXGBgXAQEwARcYGBcBARcYGBcBUAkJDg4JCQkJDg4JCaAJCQ4OCQkJCQ4OCQmgCQkODgkJCQkODgkJUAEXGBgXAQEXGBgXAdAb",
    "DwwMDxsbDwwMDxsAAQAQ/9kB5wGnAEYAABMzIzMyFxYVFAcGIyMxIicmNTUxNDc2MzIXFhUVMTcxNjc2FxYXFhcWBwYHBgcGJyYn",
    "JjU0NzYzMhcWMzI3NjU0JyYjIgcHfjIyMg4JCQkJDoAOCQkJCQ4OCQkSLDk5OTksLA8ODg8sLDk5OTksCgoJDQ0KMUBAMS8vMUBA",
    "MREBIAkJDg4JCQkJDoAOCQkJCQ4zESwPDg4PLCw5OTk5LCwPDg4PLAkNDQoJCS8vMUBAMS8vEQABABv/uQGlAccAGwAAATYnJgcF",
    "MQYXFhczMQcxBhcWNyUxNicmJyMxNwFdCRMVE/8AEAcJFXBNCRMVEwEAEAcIFm9MAZMXEA0P4A8UFAGzFxAND+APFBQBswACAAD/",
    "4AKAAaAAJQBBAAAXJicxMSYnNjc2NzQ1Njc2NxYXFhc2MxYXFhcUBxYXFhcGBwYHITcXJxcWNzcxNicmBwcxNTEmJwYHFTEnMSYH",
    "BheQPSkoAgEaGisCLS1ELSQkFhceKRsbAQYsHRwBASQlNv6QT1BQUBERUA4OEREnAhYWAicREQ4OIAIoKT0wJCQQBARELS0CARUW",
    "JBABGxspEhEJIyIvNiUkAadQUFAODlAREQ4OJ4YWAgIWhicODhERAAL/+//AAcUBwAAsADcAABMiBzExBhUVMQYHBgcVMQYHBzEG",
    "FxYXITE2NzYnJzEmJzUxJicmJzUxNCcmIxM2NSMjFBcWMzI34A4JCTgjJAEBLwgNCAkUAYAUCQgNBzABASQjOAkJDi0TQEATExoa",
    "EwHACQkOEwwrKzsTSDcJDxMSAQESEw8JNkkTOysrDBMOCQn+ExMaGhMTEwAOAAAAAAJAAYAAGQArADsATQBdAG8AfwCRAKEAswDD",
    "ANUA5QD3AAATBgcxMQYHETEWFxYXITE2NzY3ETEmJyYnIRczIzMWFxUxBgcjMSYnNTE2Nwc2NzMxFhcVMQYHIzEmJzUXMyMzFhcV",
    "MQYHIzEmJzUxNjc3NjczMRYXFTEGByMxJic1FzMjMxYXFTEGByMxJic1MTY3BzY3MzEWFxUxBgcjMSYnNTczIzMWFxUxBgcjMSYn",
    "NTE2Nwc2NzMxFhcVMQYHIzEmJzU3MyMzFhcVMQYHIzEmJzUxNjcHNjczMRYXFTEGByMxJic1NzMjMxYXFTEGByMxJic1MTY3BzY3",
    "MzEWFxUxBgcjMSYnNRczIzMWFxUxBgcjMSYnNTE2N0AbEhIBARISGwHAGxISAQESEhv+QBAgICAPAQEPIA8BAQ8QAQ8gDwEBDyAP",
    "ARAgICAPAQEPIA8BAQ9QAQ8gDwEBDyAPARAgICAPAQEPIA8BAQ8QAQ/gDwEBD+APAXAgICAPAQEPIA8BAQ8QAQ8gDwEBDyAPAXAg",
    "ICAPAQEPIA8BAQ8QAQ8gDwEBDyAPAXAgICAPAQEPIA8BAQ8QAQ8gDwEBDyAPARAgICAPAQEPIA8BAQ8BgAESEhv/ABsSEgEBEhIb",
    "AQAbEhIBQAEPIA8BAQ8gDwFwDwEBDyAPAQEPIFABDyAPAQEPIA8BsA8BAQ8gDwEBDyBQAQ8gDwEBDyAPAXAPAQEPIA8BAQ8g0AEP",
    "IA8BAQ8gDwFwDwEBDyAPAQEPIHABDyAPAQEPIA8BcA8BAQ8gDwEBDyBwAQ8gDwEBDyAPAXAPAQEPIA8BAQ8gUAEPIA8BAQ8gDwEA",
    "AAIAAP/gAkABoAAdADMAABMmNTExNDc2MzIXFzEWFRQHBzEGIyInJjU0NzcxJxMpAjIXFhUUBwYjITEiJyY1NDc2MwkJCQoNDQrA",
    "CQnACg0NCgkJqqr3ASD+4AEgDgkJCQkO/uAOCQkJCQ4BaQoNDQoJCcAKDQ0KwAkJCg0NCqmp/rcJCQ4OCQkJCQ4OCQkAAAQAAP/A",
    "AcABwAAIAFkAYgBrAAATNjcmJwYHFhc3FAcxMQYHFTE2MzMxNjc2NzUxJicmNTY3NjcWFxYXFAcGBxUxBgcGByMxBgcGBxUxFhcW",
    "FQYHBgcmJyYnNDc2NzUxNTEmJyY1Njc2NxYXFhczJicGBxYXNjcBNjcmJwYHFhdQFgICFhYCAhZQDQ0WHSNgGxISARYNDQEWFyIi",
    "FxYBDQ0WASQlNmAbEhIBFg0NARYXIiIXFgENDRYWDQ0BFhciIhcWAegCFhYCAhYWAv7IFgICFhYCAhYBWAIWFgICFhYCGBkTFAlY",
    "EQESEhsHCRQTGSIXFgEBFhciGRMUCQc2JSQBARISGwcJFBMZIhcWAQEWFyIZExQJB8cJFBMZIhcWAQEWFyIWAgIWFgICFv6IAhYW",
    "AgIWFgIAAAEAAP/AAgABwABwAAATJicmJzY3NjcWFxYXBgcGBxYXMzEWFxYXFTEWFzY3NjcWFxYXBgcGByYnJicGBxUxBgcGByMx",
    "Jic2NzY3JicmJwYHBgcWFxYXBgcjMSYnJic1MTY3FhcWFzY3NjcmJyYnBgcGByYnNTE2NzY3MzE2N8ABDBIBARISGxsSEgEBEgwB",
    "AhU5FA4NAQIVDgkOFBQODQEBDQ4UFA4JDhUCAQ0OFDkVAgEMEgEBEhIbGxISAQESDAECFXkUDg0BAhUOCQ4UFA4NAQENDhQUDgkO",
    "FQIBDQ4UeRUCAVcOCQ4UFA4NAQENDhQUDgkOFQIBDQ4UORUCAQwSAQESEhsbEhIBARIMAQIVeRQODQECFQ4JDhQUDg0BAQ0OFBQO",
    "CQ4VAgENDhR5FQIBDBIBARISGxsSEgEBEgwBAhU5FA4NAQIVAAL//f+9AgIBwgA1AEIAADcnFycmNzY3IzEiJyY3NzE2NzMxNjc2",
    "NzY3NhcWFxYHBgcGBwYHFTEGBwcxBicmNTUxBgcGJzc2NzYnJicGBwYXFhedHx8fDQUFB2oOBwYGNRUpUgQDKjIyMTElEgUHAwQa",
    "GjwFBgEiWQwMDBUPEg3jFwwKCgwXFwwKCgwXPx8fHw4SDhQMDAxZIgEGBTwaGgQDBwUSJTExMjIqAwRSKRU1BgYHDmsHBQUN2QET",
    "FBQTAQETFBQTAQAAAQAA/+ABQAGgAGcAADcUFTExMDEVMRQVIzEiBwYVFBcWMzMxFhcWFzMxMjc2NTQnJiMjMSYnJiczMTI3NjU0",
    "JyYjIzE0NTUxNDUzMTI3NjU0JyYjIzE2NzY3MzEyNzY1NCcmIyMxBgcGByMxIgcGFRQXFjMzMBAOCQkJCQ4cGDY2SBgOCQkJCQ4Y",
    "LCMjFH4OCQkJCQ6QkA4JCQkJDn4UIyMsGA4JCQkJDhhINjYYHA4JCQkJDhDQBAQQBAQJCQ4OCQlAJygBCQkODgkJARUWJAkJDg4J",
    "CQQEEAQECQkODgkJJBYVAQkJDg4JCQEoJ0AJCQ4OCQkABf/+/+ACAgGlABIAJQBQAGMAdgAAExYHMTEGBwYnJicmNzY3NhcWFwcW",
    "BzExBgcGJyYnJjc2NzYXFhcHNjcxMTY3MTE2FzYXFhcWFxYVFTEUBwYjIicnMSYHBzEGIyInJjU1MTQ3JSYnMTEmNzY3NhcWFxYH",
    "BgcGJycmJzExJjc2NzYXFhcWBwYHBifjCgkKGBkYGAwKCQoYGRgYDH8OAgMTExYWDw4DAhMTFhYPHxskIyIhFhYhIiMkGwUODRQR",
    "EVgXF1gRERQNDgUBYRMDAg4PFhYTEwIDDg8WFhNwGAoJCwsYGBkYCgkKDBgYGQFjIRscCQcQESEhGxwJBxEQIWoZGBcMCgoJGRkY",
    "FwwKCgkZykYnJg8QAQEQDyYnRg8QARQNDgQWBgYWBA4NFAEQD3YMFxgZGQkKCgwXGBkZCQoKXQkcGyEhEBEHCRwbISEREAcAAAEA",
    "AP+7AgIBxQAmAAABFgcDMQYHBicnMQcxBicmJzUxNDc3MTYnJgcHMScxJic0NwExNhcB8hACQAMNDg54RBAUEwEEqAgJCgzLWBEB",
    "EAHAEhABugsU/mAPCAcGMUoPBwkVVAYEtwsLCQi1LAkTEwoBAAkLAAACAAD/wAIAAcAAOQBMAAATJxcnJgcGBxUxFhczMTY3Nicn",
    "MTY3FhcWFwYHBgcmJyYHBgcGFxYXFhc2NzY3NjcmJyYnJiciBwYHFwYHFTEUFxcxFjc2JycxNTEmJ0siIiIMDg4BAhZuEQUGCx82",
    "UlI2NgICNjZSPjALDQwICAIDCz9TSDk6IiIBASIiOjlINS8uI7UWAgdIEREODkECFgF1IiIiCwYFEW4WAgEODgwfNgICNjZSUjY2",
    "AgEhCAIDCwsMDQgtAQEiIjo5SEg5OiIiARQUIzUCFmgKB0gODhERQV4WAgAGAAD/0AIAAbAAKgA9AFAAewCOALgAADUUFzExFjMz",
    "MRYXFjMyNzY3MzEyNzY1NCcmIyMxJicmIyIHBgcjMSIHBhUzNDcxMTYzMhcWFRQHBiMiJyY1NzQ3MTE2MzIXFhUUBwYjIicmNTci",
    "BzExBgcjMSIHBhUUFxYzMzEWFxYzMjc2NzMxMjc2NTQnJiMjMSYnJiMnIicxMSY1NDc2MzIXFhUUBwYjNyYnMTEmIyIHBgcjMSIH",
    "BhUUFxYzMzEWFxYzMjc2NzMxMjc2NTQnJiMjCQkONwkUExkZExQJ9w4JCQkJDvcJFBMZGRMUCTcOCQmACQkODgkJCQkODgkJwAkJ",
    "Dg4JCQkJDg4JCSAZExQJ9w4JCQkJDvcJFBMZGRMUCTcOCQkJCQ43CRQTGaAOCQkJCQ4OCQkJCQ5JCRQTGRkTFAlXDgkJCQkOVwkU",
    "ExkZExQJ1w4JCQkJDtcgDgkJFg0NDQ0WCQkODgkJFg0NDQ0WCQkODgkJCQkODgkJCQkOoA4JCQkJDg4JCQkJDlANDRYJCQ4OCQkW",
    "DQ0NDRYJCQ4OCQkWDQ0wCQkODgkJCQkODgkJQBYNDQ0NFgkJDg4JCRYNDQ0NFgkJDg4JCQAAAgAA/8ABwAHAACEAMgAAEwc3ByMx",
    "IgcGFRQXFjMhMTI3NjU0JyYjIzEnMSYnIzEGBwUpAhMxFhcWMzMxMjc2NxOHBwcHYA4JCQkJDgGADgkJCQkOYAcJFHgUCQEZ/oAB",
    "gP6AFQINDhP2Ew4NAhUBrg4ODgkJDg4JCQkJDg4JCQ4RAQERbv6tEw0NDQ0TAVMAAgAA/+ACAAGgAB8ARQAAEzQnMTEmIyIHBhUR",
    "MRYXFhchMTI3NjU0JyYjITEmJxEFNjUxMTQnJiMiBwcxJzEmIyIHBzEGFRQXFjMyNzcxFzEWMzI3N0AJCQ4OCQkBFhciAZAOCQkJ",
    "CQ7+cA8BAZcJCQoNDQppOQoNDQpwCQkKDQ0KWTkKDQ0KgAGADgkJCQkO/rAiFxYBCQkODgkJAQ8BUFcKDQ0KCQlqOgkJcAoNDQoJ",
    "CVo6CQmAAAMAAP/AAoABwAAaADEAUwAAEzQ3MTE2NzYzMhcWFxYVFAcGBwYjIicmJyY1AzY3MTE2NzMxFhcWFxQHBiMhMSInJjUl",
    "NRU1IzEmJzY3MzE1MTY3FhcVMTMxFhcGByMxFTEGByYnYBERHh4iIh4eERERER4eIiIeHhERYAIyM0tcSzMyAgkIDf58DQgJAfhA",
    "FgICFkACFhYCQBYCAhZAAhYWAgFAIx0dEhEREh0dIyMdHRIRERIdHSP+nkszMgICMjNLDQgJCQgNqkBAQAIWFgJAFgICFkACFhYC",
    "QBYCAhYABwAA/+ACQAGgAA0AHgAxAD4ASwBYAGUAABEpAiYnJichMQYHBgcVGQIWFxYXITE2NzY3ETEhEzY3MTE2NzMxFhcWFwYH",
    "IzEmJzcWFxYHBgcmJyY3NjcXNjczMRYXBgcjMSYnFTY3MzEWFwYHIzEmJxU2NzMxFhcGByMxJicCQP3AAkABEhIb/kAbEhIBARIS",
    "GwHAGxISAf3AQAEPDxZ2Fg8PAQEKygoBcCQTEhITJCQTEhITJLABD4APAQEPgA8BAQ+ADwEBD4APAQEPgA8BAQ+ADwEBYBsSEgEB",
    "EhIbIP7gASD+4BsSEgEBEhIbASD+6xYPDwEBDw8WCgEBCtUBHyAgHwEBHyAgHwEQDwEBDw8BAQ9ADwEBDw8BAQ9ADwEBDw8BAQ8A",
    "AwAA/8ABwAHBACYAXgBnAAABJgcxMQYHMTEGBxUxFhcWFzMxFTEUFxYzMjc2NTUxNTE1MTQnJiMFJiciBwcxBhUWFxYXFTEUFxYz",
    "Mjc2NTUxNjc2NzQnJzEmIwYHFTEGByYnJzEmJwYHBzEGByYnNRc5BDUxFQGgCh4fGxwCARISGyAJCQ4OCQkJCQ7+oAENDgQeAgEW",
    "FyIJCQ4OCQkiFxYBAh4EDg0BAQkIAgwCDg4CDAIICQEwAcABDw4mJ0dwGxISAYAOCQkJCQ6AcNAOCQkQDQMNiAkKIxgZBOAOCQkJ",
    "CQ7gBBkYIwoJiA0DDYYJAQEIiA4BAQ6ICAEBCYaYAQEAAgAQ/9kB8AGnADAAYgAAEzYzMTEyFwcxBhcWFzMxMDEwMTMxNjc1MSYn",
    "JgcHMSYnJgcGBwYHBhcWFxY3Njc2NwcVNRUxMRUxFhcWNzcxFhcWNzY3Njc2JyYnJgcGBwYHBiMiJzcxNicmJyM5AiMxBgePMT9A",
    "MSkLBgYQeAgWAgEODgwqLDk5ODksJRAEBQYMDQwLBQwafwEODgwqLDk5ODksJRAFBgYMDQwLBQsbMT9AMSkLBgYQeAgWAgExLy4p",
    "DA4OAQIWgBAGBgsqLA4ODg8sJS4NDAsFBAUGDCEbqQgICHgQBgYLKiwODg4PLCUuDQwLBQQFBgwiGi8uKQwODgECFgAC//v/4AIF",
    "AagAFQA6AAATNjMzMTIXFzEWBwMxBiMiJwMxJjc3FwYXFzEHMQYHFhcXMTIxMDM3MTY3JicnMTcxNicmBwcxJzEmB3UHDPAMB3AK",
    "C+gHCwsH6AsKcCYFAzqUBgEBBsABAcAGAQEGkzkDBQYFWloFBgGeCgqYEA7/AAgIAQAOEJgoBAZgDAEHBwEQEAEHBwEMYAYEBAVh",
    "YQUEAAABAAD/wAJAAcAAOwAAATY3MTE2NxYXFhcVMRQXFjMyNzY1NTEmJyYnBgcGBxUxIzEGBwYHFTEWFxYXITE2NzY3NTEmJyYn",
    "IzE1AWABFhciIhcWAQkJDg4JCQIoKT09KSgC4BsSEgEBEhIbAUAbEhIBARISGyABMCIXFgEBFhciMA4JCQkJDjA9KSgCAigpPTAB",
    "EhIbwBsSEgEBEhIbwBsSEgEwAAIAD/+9AfEBwAAeACsAAAEyFxcxFhcWFRYHBgcGBwYnJicmJyY3NDc2NzcxNjMVGQI2NzY3NjUn",
    "MTEBAAcGvREKCwESEi8uVhoaVi4vEhIBCwoRvQYHRCcmEA+wAcADUAcPDxQzRUVBQisMDCtCQUVFMxQPDwdQA0P+hgF6/oYjNjY5",
    "Oi5KAAADAAD/wAJCAcAAWwCQAJoAAAEVNRUWFxYHBicmIyIHBhUiFRQxMDEwMRQXFhczMRYXFhcGBwYHFTEGByYnNTEmJyIjJiMm",
    "IyY3NhcWMxYXFhcyNzY1NjUxMTYnJicnMSYnJic2NzY3NTE2NxYXARYHMTEGBwcxBisCIicmNTUxNDc2MzMxNzE2OwIyFxYVFAcG",
    "KwIGBxYXMzE3MTYXFhcFOQIjMTAxMDMBOAoIFQQHFhENDAgDAQMJEwESExgDAhkKCwIWFgIOCgEBAQECAhQFCRUCAgICEw8MBwMB",
    "AQUIEwISExcDAxkJCwIWFgIBAAoCAw1/JC2goA4JCQkJDiUtIy1OUA4JCQkJDkAQDwEBD3l3DhAQCv6KAQEBqAsLCwEDBxYVBAUF",
    "AgECAQECBAYECw0gIg8GAgsWAgIWCwQEAQEJFhQFAQEBBwEEAgEBAwEEBQUBBAoMICMNBQMLFgICFv7IDhAQCl4aCQkOQA4JCSQc",
    "CQkODgkJAQ8PAVgKAgMNMAAABAAA/8ACgAHAABoAMQBLAFwAABM0NzExNjc2MzIXFhcWFRQHBgcGIyInJicmNQM2NzExNjczMRYX",
    "FhcUBwYjITEiJyY1BSMzIzY1NTE0JyYnMDEyMzMxFhcWFxQHBiMDJic2NzQnNjcWFxYXBgcGB2ARER4eIiIeHhEREREeHiIiHh4R",
    "EWACMjNLXEszMgIJCA3+fA0ICQJhioqKCRMSIQQDPkQuLQIJCQ2xMB8eARIcJjAfIAEBIB8wAUAjHR0SERESHR0jIx0dEhEREh0d",
    "I/6eSzMyAgIyM0sNCAkJCA0eDhIILicnHAItLkQNCQkBAAEgKTYpIRUBASAfMDAfIAEABgAA/8ACAAHAABYAQwBUAHgAigCfAAAB",
    "BgcGByYnJiciBycxJic2NzY3FhcWFwU2MzIXFhcWFxQHBgcwMTAxMDEwOQQGMTAxBgcGIyYnJicmJzY3Njc2NxcmJzY3NjcVMQYH",
    "BgcwMTQ1BwYHBgciBwYHIicmJyYnNTEWFxYXNjc2NzY3Njc0MxUxFTEVMzUVNTUxNjc2NxUxFAcGBzQ1BzY3NjcVMQYHBgcmJyYn",
    "NTEWFxYXAgABJS5NBQY9VwwMAiUBAjY2UlI2NgL+oQ8QLycoGyYBAggbARsoJzBcOAMDJQEBIyM5EBH/AhYrIRkTASsWHiABJQIC",
    "AQE4XDAnKBslARMZPVdXPQwLCQgBAgEgHRcZEw8aN+BXPRkTAjY2UlI2NgITGT1XAXAbFRkGAwIZAQEBFRsiFxYBARYXIlEBCQgO",
    "FRwGBhQPAQ8ICQEcAgEVGxsUFAgDAU8hFAcOCg8jHhULBwIDYBsVAQEBHAEJCA8VGyMPChkBARkFBgUGAQEBAwYaICAgGgYKCg8j",
    "EA8ZDQIDcAEZCg8jIhcWAQEWFyIjDwoZAQAABgAA/9oCQAGmACEANAA+AEgAUgBcAAAZAxYXFjc2NzY3NhcWNzY3ETEmJyYHBgcG",
    "BwYnJgcGBwUmJzExJic2NzY3FhcWFwYHBgcjFhcxMRYXIzE1NwYHMTEGBzUxMwUVNRUjMTY3NjcnMyMzFTEmJyYnARpBQkFBPDw8",
    "OxIPDwEBGkFBQkE8PDw7Ew4PAQEgIhcWAQEWFyIiFxYBARYXIuAbEhIBQEABEhIbQAGAQAESEhtAQEBAGxISAQFP/ssBNf7LHgwW",
    "CAgSEQkIDwQKCRMBNR4MFggIEhEICQ8ECQoT7wEbGykpGxsBARsbKSkbGwEBEhIbQNAbEhIBQKBAQEAbEhIB0EABEhIbAAUAAP/A",
    "AgABwAAwAEMAVgBpAHwAACUUOQIUFQYHBiMjMQYHBgcUFxYXFBcWFxQHBgciIyYnJicmJzY3Njc2NxYXFhcWFwU0JzExJiMiBwYV",
    "FBcWMzI3NjU1MjcxMTY1NCcmIyIHBhUUFxYzNzQnMTEmIyIHBhUUFxYzMjc2NRcyNzExNjU0JyYjIgcGFRQXFjMCAAEVFBxiFA4N",
    "AQEDBwEKAg8OGAYFSDk6IiIBASIiOjlISDk6IiIB/oAJCQ4OCQkJCQ4OCQkOCQkJCQ4OCQkJCQ6gCQkODgkJCQkODgkJYA4JCQkJ",
    "Dg4JCQkJDsABAQEbEREBDQ4UBQUODgEBFBYYEhICASIiOjlISDk6IiIBASIiOjlIIA4JCQkJDg4JCQkJDmAJCQ4OCQkJCQ4OCQlg",
    "DgkJCQkODgkJCQkOYAkJDg4JCQkJDg4JCQAAAwAA/+ACAAGgAA0ATgB0AAATFTUVMzE1MSYnIzEGBwc1FTU2NzY3MzEWFxYXFTEz",
    "MTIXFzEWFRUxIzE1MTQnJiMiBwYVFTEjMTUxNCcmIyIHBhUVMSMxNTE0NzcxNjMzAzUVNTMxFBcWMzI3NjUzMRQXFjMyNzY1MzEV",
    "MQYHBgchMSYnJiewoAEHkAcBMAEPEBiQGBAPARwUDjQOgAkJDg4JCYAJCQ4OCQmADjQOFByAgAkJDg4JCYAJCQ4OCQmAARISG/6A",
    "GxISAQFoKCgoKAcBAQcoKCgoGBAPAQEPEBgoDjQOFFwgDgkJCQkOICAOCQkJCQ4gXBQONA7+4EBAQA4JCQkJDg4JCQkJDkAbEhIB",
    "ARISGwADAAD/vgFCAcYADABWAG0AABM2NzYXFhcGBwYnJicHBiMxMSIVBzEGBwcxBgcGJyYnJjc3MTY3NzE2MzIXFhcXMRcxFhcW",
    "BwYHBicnMSYnJzEHMRcxFhcXMRYHBgcGJyYnJzEnMSY3Nwc3BzcWFxcxBzEGBwcxBiMiJyY1NDc3oAEXGBgXAQEXGBgXASEBAQEI",
    "GgkDBAwLDQ0GBQQCEzMIHyMiGxsODxUMBAQFBwwMDBsQBwkUMggDFwMHBg0OCwoEFkcWCBA5GRkZAwQoDgQHPQoNDQoJCTwBkBsP",
    "DAwPGxsPDAwPG5cBAQMMGggNBQYEBAwLDQg1GAMOEhMfJQoHDAwMDAQEBQ4IEBdBNgkMXA0LCwQDBwYNWE4aIUDHPj4+BAQtJAkH",
    "PgkJCg0NCjsAAgAA/+ACAAGgACkAPAAAEwYHMTEGBxExFhcWFyExNjc2NzUxJicmJyExJic2NyExMjc2NTQnJiMhBTIXMTEWFRQH",
    "BiMiJyY1NDc2M0AbEhIBARISGwGAGxISAQESEhv+kA8BAQ8BcA4JCQkJDv6AAWAOCQkJCQ4OCQkJCQ4BoAESEhv+wBsSEgEBEhIb",
    "4BsSEgEBDw8BCQkODgkJ8AkJDg4JCQkJDg4JCQAFAAD/wAGAAcAAHQAkADEAPgCdAAATBgcxMQYHETEWFxYXITE2NzY3ETEjMSIn",
    "JjU1MSMzFTUVMzEnBzY3MzEWFwYHIzEmJxU2NzMxFhcGByMxJicXFhcVMRYXFgcGJyYjIgcGFQYXFhc5BTAxFhcWFwYHBgcVMQYH",
    "Jic1MSYnOQMmJyY3NhcWFzA5BjIVFhcyNzY1NCcmJyc5AiYnJic2NzY3NTE2N0AbEhIBARISGwEAGxISAYAOCQmgwICAwAEPQA8B",
    "AQ9ADwEBD0APAQEPQA8BgA8BDQsOAwUOEQ8OCggBCAsTEhIVAgEWDA0BDw8BEQ4DAw4EBg4EAwETEA8JCAgKEwESERQDAhYLDQEP",
    "AcABEhIb/oAbEhIBARISGwEgCQkOgICAgIBQDwEBDw8BAQ9ADwEBDw8BAQ9IAQ8RAgMFDw4DBQYECAUFBgUFCgsbHQ0HAhEPAQEP",
    "EgMGAQEGDg0DAQEBBwEFBQkHBQYFAQQJCxsdCwcCEQ8BAAMAAP/AAgABwAA+AFgAcgAAAQYHMTEGBxUxBgcmJzUxNjc2NzY3FhcW",
    "FxYXFTEGBwYHIzEGByMxJicmJzY3NjczMRYXMzEyNzY1NTEmJyYnBzMjMzIXFhUVMRQHBiMjMSYnJic1MTY3NjczFhcxMRYXFTEG",
    "BwYHIzEiJyY1NTE0NzYzMwEAWDs7AgIWFgIBIiI6OUhIOToiIgEBGRklbg4cIBQODQEBDQ4UIBwObhELDAI7O1hwEBAQDgkJCQkO",
    "EBsSEgEBEhIb4BsSEgEBEhIbEA4JCQkJDhABkAI7O1goFgICFihIOToiIgEBIiI6OUiQJRkZARcBAQ0OFBQODQEBFwwLEZBYOzsC",
    "oAkJDnAOCQkBEhIbMBsSEgEBEhIbMBsSEgEJCQ5wDgkJAAEAAAAgAkABYABGAAATFhcxMRYzMzEyNzY3Njc2MxYXFhcGBwYVFBcW",
    "FwYHBgciJyYnJicmIyMxIgcGBwYHBiMmJyYnNjc2NTQnJic2NzY3MhcWF5oFCgoNwA0KCgUKExQZIhcWAQIoBgYoAgEWFyIZFBMK",
    "BQoKDcANCgoFChMUGSIXFgECKAYGKAIBFhciGRQTCgEvDAoJCQoMFg0OARYXIjAWBAYGBBYwIhcWAQ4NFgwKCQkKDBYNDgEWFyIw",
    "FgQGBgQWMCIXFgEODRYAAwAg/7sCIAHFABMALABGAAABNhcXMRYXBgcHMQYnJzEmJzY3NxcXJxcWFwYHBzEGJycxJic2NzcxFzEW",
    "NzcHNwc3FzEWFwYHBzEGJycxJic2NzcxFzEWNwEJFxjaDQEBDdsXGNoNAQEN29Q1NTUNAQEN2xcY2g0BAQ01mCUlmJiYmJg1DQEB",
    "DdsXGNoNAQENNZglJQG7CgplBw8PB2UKCmUHDw8HZc0YGBgHDw8HZQoKZQcPDwcYRhAQRsZGRkYYBw8PB2UKCmUHDw8HGEYQEAAA",
    "A//+/8ACQAHAAB4AUwBcAAABNwc3NjcyFxcxMzEyFxcxMzEWFxUxBgcGByMjBzEnFxU1FRQHBiMjMSInJjU1MQYjIicVMRQHBiMj",
    "MSInJjU1MSYnJzEmNzY3NhcWFxcxFhczMxc3JicGBxYXNjcBNhcXFwQTDAcRNBQOEjgWAgEWFyIgJQVwagkJDiAOCQkkLCwkCQkO",
    "IA4JCS0OBAMHBg0OCwoEBAcYHrBwMAEPDwEBDw8BASGLi4sTAQoWDhICFhgiFxYBH0Bh4ODgDgkJCQkOcxMTcw4JCQkJDuYSMQ8N",
    "CwsEAwcGDRAXAUCwDwEBDw8BAQ8AAQAA/8AB/gHAAEMAADcUBwcxBiMGJyYjBgcGBxYXFhcWFxYXFhc2NzY3NCcmNzQ3NzE2MzMx",
    "Mjc2NzYnJjU2NzY3MhcWNzYnJicmJwYHBgcVoAkbCg0ODQYIGRERAQERERkLAQERERkZEREBAgMBCRsKDVkJCgkCAwQNASAfMAwL",
    "CQcHAQwvMEJLMTICtw0KGwkBAwIBEREZGRERAQELGRERAQERERkHBw4NDQobCQECCAgIGB0wHyABAgIFBQk/KCkBAjIxS1kAAAUA",
    "IP/AAaABwAAQACAANgBMAJAAABMyFzExFhUVMSMxNTE0NzYzBzQ3MTE2MzIXFhUVMSMxNTM0NzExNjMyFxYVFTEUBwYjIicmNTUX",
    "NDcxMTYzMhcWFRUxFAcGIyInJjU1BzUVNRYzMjcWFxYzMjcVMRQHBgcVMRQHBiMjMSInJjU1MSYnJzEmJzUxNjc2NzMxMhcWFRQH",
    "BiMjMQYHFhczMTY3NjfADgkJQAkJDoAJCQ4OCQlAwAkJDg4JCQkJDg4JCWAJCQ4OCQkJCQ4OCQlgDhIUEAYREBUSDhERHgkJDqAO",
    "CQkaFQslAQESEhtYEQsMDAsROA8BAQ84HxQUAQHACQkOcHAOCQlADgkJCQkOUFAOCQkJCQ5gDgkJCQkOYEAOCQkJCQ5ADgkJCQkO",
    "QFgBAQEJCxMMDAkJKCEhFmAOCQkJCQ5ODBULJjUbGxISAQwLERELDAEPDwEBFBQfAAAE//r/wAIAAcYAKwA7AGgAcQAAEyYHBzEG",
    "FxcxFjMzMRcxBhcWFxcxFjMyNzcxNjU0JycxJicmBycxNTE0JycDBhUWFxYXMjc3MSY3JzEHJTQnJicmBwcxBiMjMSYnNTE0Nzcx",
    "NicmJyYjBgcGBxUxFzE2FxYXFzE2NzY3ATY3FhcGByYnTxEPKA0LUAcMNm0LBAMScAoNDQpACQlwExgZFm0JaDsUARMTHRwUdgwI",
    "PpQB7AMDBwgGQAUHOQ8BBUAGAgIIDxA9KSgCVRwbHBUQJRcWAf44AhYWAgIWFgIBuwsNKA8RaAltFhkYE3AJCUAKDQ0KcBIDBAtt",
    "NgwHUP55FBwdExMBFHYgIT6V/BAOCQIBBj8FAQ85BwVABggHAwMCKCk9AVUHBwgVEBIjIiz+4BYCAhYWAgIWAAMAAP/AAgABwAAQ",
    "ADgAhgAAASMzIycxJjc2NzMxFhcWDwIzIzMWFzAxFhcWFxYXBgcGByExJicmJzY3Njc2NzA5BDY3NjcXJicGBxUxBgcGBxYXFhcX",
    "MRYXFgcUBwYjJicmJyYHBhcWFzkDFhcVMRYXNjc1MTY3NjcmJyYnMTE1MSYnJjcmNzYzMhcWNzYnJic1AUCAgIAvBQQECsQKBAQF",
    "L4CAgIAGBx4qKSAgAgEbGyn+wCkbGwECICApKh4CAwQEVAISEgIMChgCAxYSEQITCQcBBggNEBMEBBIHBBEDAwwQAhISAgwLFwID",
    "FhITEwoGAQEHCQ0OERIGAxEKCwFgRwkIBwEBBwgJRyAEBBIiIzc4UikbGwEBGxspUjg3IyISAQICA1gSAgISDgIHDB8eCwoEAQUF",
    "BQQHAwUBCAEBBBASCAEBBQMPEgICEg4CBw0gHgsLBAEFBQQDBQQFBQMREgcCAg4AAAUAAP/AAYABwAAGAA0AFAAbADUAADc3Bzcn",
    "MREXMyMzJzEHNxcnFxExBzcjMyMXMTclNjcxMTY3ITEWFxYXETEGBwYHITEmJyYnEUBaWlpaJ7Ozs1pZgFlZWVkzs7OzWVr+5gEN",
    "DhQBIBQODQEBDQ4U/uAUDg0BOoaGhob+9DqGhsCGhoYBDIbAhoYQFA4NAQENDhT+YBQODQEBDQ4UAaAAAAIAAP/IAfABuAAcAFsA",
    "ABMGBzExBgcxMQYHFhcWFxYXNjc2NzY3JicmJyYnFwYHMTEGBzExBgcGJyInJicmJyYnJjc2NzY3Njc2NzY3NicmBwYHBiciJyYn",
    "JiMmNTY3Njc2NzYzMhcWFxQV+EU4OCEhAQEhITg4RUU4OCEhAQEhITg4RXMCBQUGBgQGCxAPBAQRDAwPDwMCCgMDAQoQExQCAQID",
    "AgRlDwwHCwsJAwMVARFtJDISEwUFBQMBAbgBISE4OEVFODghIQEBISE4OEVFODghIQGpFCIhIiIXGgEMAwMLCQgJCwcICAMDAggP",
    "ExIFAQMCAQFFCgEDAgQBBQoHBy8PFQYHAwMEBQUAAAQACP/IAfgBuAAcAG8AggCVAAAlBgcxMQYHMTEGByYnJicmJzY3Njc2NxYX",
    "FhcWFyc2JzExJic3MScxBzEmJzcxJzEHMSYnMTEnMQcxMhcWMxYHBzEWMzAjIicHMQYnIicmJwcxFzEWFxYXBzEXMTcxFhcHMRcx",
    "NzEWNzY3NicmJzY3BwYnMTEmJzExJiM3MRYzFhcWBzcGJzExJicxMSYnNzEWMxYXFgcB+AEhITg4RUU4OCEhAQEhITg4RUU4OCEh",
    "AY4DDxAaCxsLCwsLGwsJCSUHAQkIAQ8CDQECAQEBEgELAQkJAQ0jBgYEAwsbDAoLCxsMIxkYDAgHCBIcBj4IGhoSAwMPAwQUFxcE",
    "CQcWFg8DAg4CAxETEwPARTg4ISEBASEhODhFRTg4ISEBASEhODhFIxkPDgktBisDAiwHLQICCR0CAgYKMwEBSAcBAgIBHwkCAQEB",
    "LQcsAgMtBi0IBwceGRAQCQUjVxYCAgYBPAEECgsXWBQBAQUBATYBAwkJFQADABT/4AJzAaAASABbAG4AAAEmMSYnIgcGByYHJicm",
    "IwYHMAcGBwYXFhUWFzI3NjcwNTQjJicmNTQzNjc2MxYzMjcyFRYXMBUUBwYHIgcUMxYXFDM2NzQ1NicBJicxMSY1NDc2NxYXFhUU",
    "BwYHMyYnMTEmJzY3NjcWFxYXBgcGBwINATo+AQEIB0NDBwgBAT46ATgUEwgBQ1ABARENARgWAQEFBAEBSUtMSAEFBQEWFwEBAQ0R",
    "Ak9EEGb+0RYPDw8PFhcPDw8PF8QWDw8BAQ4PFxcPDgEBDw4XAXoBGgsBDxALCxAPAQsaAVVUU1IBATEZARcaAQEJDQEBAQQDASEh",
    "AQMEAQEBDQkBARoXARkxAQG9kf70ARERGRkREAEBERAZGRERAQERERkZERABAREQGRkREQEAAAAAAAIAHgADAAEECQABADIAAAAD",
    "AAEECQACAAoAMgBGAG8AbgB0ACAAQQB3AGUAcwBvAG0AZQAgADYAIABGAHIAZQBlACAAUwBvAGwAaQBkAFMAbwBsAGkAZAAAAAMA",
    "AAAAAAD/2wAZAAAAAAAAAAAAAAAAAAAAAAAAAAA=",
})
...
PCS_IC = {
    ...
    history = "\239\135\154", -- fa-clock-rotate-left (was wrong code f15a -> drew "?")
    phone = "\239\130\149", -- fa-phone (was wrong code f551 -> drew "?")
    heart = "\239\128\132", -- fa-heart
    idcard = "\239\139\130", -- fa-id-card (was wrong code f0bc -> drew "?")
    crosshairs = "\239\129\155", -- fa-crosshairs (was wrong code f15b)
    fire = "\239\129\173", -- fa-fire (was wrong code f4a5)
    list = "\239\128\186", -- fa-list
    book = "\239\128\173", -- fa-book
    home = "\239\128\149", -- fa-house
    circleplus = "\239\129\149", -- fa-circle-plus
    rocket = "\239\132\181", -- fa-rocket
    tag = "\239\128\171", -- fa-tag
    branch = "\239\132\166", -- fa-code-branch
    chevdown = "\239\129\184", -- fa-chevron-down
    chevright = "\239\129\148", -- fa-chevron-right
    gift = "\239\129\171", -- fa-gift
    bell = "\239\131\179", -- fa-bell
    palette = "\239\148\191", -- fa-palette
    plane = "\239\135\152", -- fa-paper-plane
    wallet = "\239\149\149", -- fa-wallet
    layers = "\239\151\189", -- fa-layer-group
    puzzle = "\239\132\174", -- fa-puzzle-piece
    tools = "\239\159\153", -- fa-screwdriver-wrench
    chart = "\239\136\129", -- fa-chart-line
    link = "\239\131\129", -- fa-link
    eye = "\239\129\174", -- fa-eye
    keyboard = "\239\132\156", -- fa-keyboard
    font = "\239\128\177", -- fa-font
    listul = "\239\131\138", -- fa-list-ul
    toolbox = "\239\149\146", -- fa-toolbox
...
local function dataRow(label, value, valColor, icon, iconCol)
    ...
    dl:AddRectFilled(
        imgui.ImVec2(p.x,       p.y),
        imgui.ImVec2(p.x+avail, p.y+h),
        imgui.ColorConvertFloat4ToU32(iv4(bgR,bgG,bgB, St._softRows and 0.42 or (cfg.rowBgAlpha or 0.98))), 5)
...
local function drawCharLeftInner(s, h)
    if St._resetCharScroll then imgui.SetScrollY(0) end
                secTitle((PCS_IC.sack or "") .. "  " .. u8"\xc1\xe0\xeb\xe0\xed\xf1")
                dataRow(u8"SA$", s.cashSas~="" and fmtMoney(s.cashSas) or "-", thGreen(), PCS_IC.money, {0.30,0.90,0.45})
                dataRow(u8"\xc1\xe0\xed\xea", s.bank~="" and fmtMoney(s.bank) or "-", thAcc(), PCS_IC.coins, {0.40,0.70,1.0})
                dataRow(u8"\xc4\xe5\xef.", s.moneyDay~="" and fmtMoney(s.moneyDay) or "-", thGold(), PCS_IC.handdollar, {1.0,0.80,0.25})
                dataRow(u8"\xca\xe0\xf0\xf2\xe0", s.bankCard, nil, PCS_IC.idcard or PCS_IC.user, {0.70,0.75,0.90})
                if hasVal(s.cashVcs) then dataRow(u8"VC$", fmtMoney(s.cashVcs), nil, PCS_IC.coins, {0.35,0.85,0.95}) end
                if hasVal(s.btc) then dataRow("BTC", fmtAmt(toNum(s.btc)), nil, PCS_IC.bitcoin, {0.95,0.70,0.20}) end
                if hasVal(s.euro) then dataRow(CUR_AARP_SHORT, fmtAmt(toNum(s.euro)), nil, PCS_IC.euro, {0.45,0.65,1.0}) end
                if hasVal(s.azCoins) or hasVal(s.accountState) then
                    local azRaw = hasVal(s.accountState) and s.accountState or s.azCoins
                    dataRow("AZ", fmtAmt(toNum(azRaw)), thGold(), PCS_IC.gem, {0.90,0.55,1.0})
                end
                do
...
local function drawCharRightInner(s, h)
    if St._resetCharScroll then imgui.SetScrollY(0) end
                secTitle((PCS_IC.user or "") .. "  " .. u8"\xcb\xe8\xf7\xed\xee\xe5")
                dataRow(u8"\xd2\xe5\xeb\xe5\xf4\xee\xed", s.phone, nil, PCS_IC.phone or PCS_IC.terminal, {0.45,0.80,1.0})
                dataRow(u8"\xcf\xee\xeb", s.gender, nil, PCS_IC.user, {0.90,0.70,0.90})
                dataRow(u8"\xc7\xe4\xee\xf0\xee\xe2\xfc\xe5", s.health,
                    (tonumber((s.health or ""):match("%d+")) or 100)>=80 and thGreen() or thRed(),
                    PCS_IC.heart or PCS_IC.star, {1.0,0.35,0.45})
...
-- ============================================================
--  ИСТОРИЯ ВЕРСИЙ / "ЧТО НОВОГО" (v1.9.3)
-- ------------------------------------------------------------
-- Список версий вшит прямо в скрипт (работает без интернета). Порядок:
-- НОВЫЕ ВЕРСИИ СВЕРХУ. Чтобы добавить новую версию — вставь ещё один блок
-- { ver = "1.9.4", label = "v1.9.4", sub = u8"...", items = { ... } }
-- в начало таблицы PCS_CHANGELOG. Строка пункта:
--   { "иконка из PCS_IC", "цвет (g/b/p/o/y/c/r)", u8"Заголовок", u8"Описание" }
...
PCS_CHANGELOG = {
    { ver = "1.9.3", label = "v1.9.3", sub = u8"\xd7\xf2\xee \xed\xee\xe2\xee\xe3\xee \xe8 \xe8\xf1\xf2\xee\xf0\xe8\xff \xe2\xe5\xf0\xf1\xe8\xe9", items = {
        ...
        { "palette", "p", u8"\xc0\xea\xea\xf3\xf0\xe0\xf2\xed\xee\xe5 \xee\xf4\xee\xf0\xec\xeb\xe5\xed\xe8\xe5", u8"\xc7\xed\xe0\xf7\xea\xe8, \xf6\xe2\xe5\xf2\xed\xfb\xe5 \xe7\xe0\xe3\xee\xeb\xee\xe2\xea\xe8 \xe2\xe5\xf0\xf1\xe8\xe9 \xe8 \xee\xf2\xf1\xf2\xf3\xef\xfb \xe2\xec\xe5\xf1\xf2\xee \xe3\xee\xeb\xee\xe3\xee \xf2\xe5\xea\xf1\xf2\xe0." },
        { "idcard", "y", u8"\xc7\xed\xe0\xf7\xea\xe8 \xe2\xec\xe5\xf1\xf2\xee \xe7\xed\xe0\xea\xee\xe2 \xab?\xbb", u8"\xd2\xe5\xeb\xe5\xf4\xee\xed, \xe7\xe4\xee\xf0\xee\xe2\xfc\xe5, \xe1\xe0\xed\xea\xee\xe2\xf1\xea\xe0\xff \xea\xe0\xf0\xf2\xe0 \xe8 \xea\xed\xee\xef\xea\xe0 \xe8\xf1\xf2\xee\xf0\xe8\xe8 \xf2\xe5\xef\xe5\xf0\xfc \xf1 \xed\xee\xf0\xec\xe0\xeb\xfc\xed\xfb\xec\xe8 \xe8\xea\xee\xed\xea\xe0\xec\xe8." },
    } },
    { ver = "1.8-1.9.2", label = "v1.8 - v1.9.2", sub = u8"\xce\xf5\xf0\xe0\xed\xed\xe8\xea\xe8, \xed\xe0\xeb\xee\xe3\xe8, \xee\xf4\xee\xf0\xec\xeb\xe5\xed\xe8\xe5", items = {
        { "paw", "o", u8"\xc2\xea\xeb\xe0\xe4\xea\xe0 \xab\xce\xf5\xf0\xe0\xed\xed\xe8\xea\xbb", u8"\xd1\xef\xe8\xf1\xee\xea \xee\xf5\xf0\xe0\xed\xed\xe8\xea\xee\xe2 \xe8 \xe2\xfb\xe1\xee\xf0 \xe5\xe4\xfb \xe4\xeb\xff \xea\xe0\xe6\xe4\xee\xe3\xee \xef\xf0\xff\xec\xee \xe2 \xec\xe5\xed\xfe." },
        { "taxes", "y", u8"\xce\xef\xeb\xe0\xf2\xe0 \xed\xe0\xeb\xee\xe3\xee\xe2 \xef\xf0\xe8 \xe2\xf5\xee\xe4\xe5", u8"\xd7\xe5\xf0\xe5\xe7 \xec\xe8\xed\xf3\xf2\xf3 \xef\xee\xf1\xeb\xe5 \xe2\xf5\xee\xe4\xe0 \xe2 \xe8\xe3\xf0\xf3 \xed\xe0\xeb\xee\xe3\xe8 \xee\xef\xeb\xe0\xf7\xe8\xe2\xe0\xfe\xf2\xf1\xff \xf1\xe0\xec\xe8, \xe5\xf1\xeb\xe8 \xe5\xf9\xb8 \xed\xe5 \xe1\xfb\xeb\xe8 \xee\xef\xeb\xe0\xf7\xe5\xed\xfb." },
        { "clock", "c", u8"\xc0\xe2\xf2\xee\xee\xef\xeb\xe0\xf2\xe0 \xef\xee \xf2\xe0\xe9\xec\xe5\xf0\xf3", u8"\xc8\xed\xf2\xe5\xf0\xe2\xe0\xeb \xef\xee\xe2\xf2\xee\xf0\xed\xee\xe9 \xee\xef\xeb\xe0\xf2\xfb \xe7\xe0\xe4\xe0\xb8\xf2\xf1\xff \xe2 \xf7\xe0\xf1\xe0\xf5, \xe2\xe5\xe4\xb8\xf2\xf1\xff \xf1\xf7\xb8\xf2\xf7\xe8\xea \xab\xc2\xf1\xe5\xe3\xee \xef\xee\xf2\xf0\xe0\xf7\xe5\xed\xee \xed\xe0 \xed\xe0\xeb\xee\xe3\xe8\xbb." },
        { "calendar", "g", u8"\xca\xe0\xeb\xe5\xed\xe4\xe0\xf0\xfc \xe8 \xeb\xee\xe3\xe8 PayDay", u8"\xc4\xee\xf5\xee\xe4 \xef\xee PayDay \xef\xee \xe4\xed\xff\xec \xe8 \xee\xe1\xf9\xe8\xe9 \xe4\xee\xf5\xee\xe4 \xe7\xe0 \xe2\xf1\xb8 \xe2\xf0\xe5\xec\xff." },
        { "star", "p", u8"\xcf\xe5\xf0\xf1\xee\xed\xe0\xe6 \xed\xe0 \xf4\xee\xed\xe5", u8"\xca\xe0\xf0\xf2\xe8\xed\xea\xe0-\xea\xee\xec\xef\xe0\xed\xfc\xee\xed \xe7\xe0 \xec\xe5\xed\xfe \xf1 \xed\xe0\xf1\xf2\xf0\xee\xe9\xea\xee\xe9 \xef\xf0\xee\xe7\xf0\xe0\xf7\xed\xee\xf1\xf2\xe8 \xe8 \xee\xf2\xf2\xe5\xed\xea\xe0." },
        { "download", "b", u8"\xce\xe1\xed\xee\xe2\xeb\xe5\xed\xe8\xe5 \xee\xe4\xed\xee\xe9 \xea\xed\xee\xef\xea\xee\xe9", u8"\xd1\xea\xf0\xe8\xef\xf2 \xf1\xe0\xec \xf1\xea\xe0\xf7\xe8\xe2\xe0\xe5\xf2 \xed\xee\xe2\xf3\xfe \xe2\xe5\xf0\xf1\xe8\xfe \xe8 \xef\xee\xea\xe0\xe7\xfb\xe2\xe0\xe5\xf2 \xe8\xed\xe4\xe8\xea\xe0\xf2\xee\xf0 \xe7\xe0\xe3\xf0\xf3\xe7\xea\xe8." },
        { "sync", "c", u8"\xca\xed\xee\xef\xea\xe0 \xab\xcf\xe5\xf0\xe5\xe7\xe0\xe3\xf0\xf3\xe7\xe8\xf2\xfc \xf1\xea\xf0\xe8\xef\xf2\xbb", u8"\xc1\xfb\xf1\xf2\xf0\xfb\xe9 \xef\xe5\xf0\xe5\xe7\xe0\xef\xf3\xf1\xea \xf1\xea\xf0\xe8\xef\xf2\xe0, \xed\xe5 \xe2\xfb\xf5\xee\xe4\xff \xe8\xe7 \xe8\xe3\xf0\xfb." },
        { "terminal", "g", u8"\xd1\xe2\xee\xff \xea\xee\xec\xe0\xed\xe4\xe0 \xee\xf2\xea\xf0\xfb\xf2\xe8\xff \xec\xe5\xed\xfe", u8"\xca\xee\xec\xe0\xed\xe4\xf3 \xec\xee\xe6\xed\xee \xef\xee\xec\xe5\xed\xff\xf2\xfc \xe2 \xab\xce \xf1\xea\xf0\xe8\xef\xf2\xe5\xbb, \xf2\xe0\xec \xe6\xe5 \xea\xed\xee\xef\xea\xe8 \xab\xca\xee\xef\xe8\xf0\xee\xe2\xe0\xf2\xfc\xbb." },
        { "shield", "r", u8"\xc7\xe0\xf9\xe8\xf2\xe0 \xee\xf2 \xe2\xfb\xeb\xe5\xf2\xee\xe2", u8"\xd1\xea\xf0\xe8\xef\xf2 \xf1\xeb\xe5\xe4\xe8\xf2 \xe7\xe0 \xee\xf2\xf0\xe8\xf1\xee\xe2\xea\xee\xe9 \xec\xe5\xed\xfe \xe8 \xf1\xe0\xec \xe8\xf1\xef\xf0\xe0\xe2\xeb\xff\xe5\xf2 \xf1\xe1\xee\xe8, \xf7\xf2\xee\xe1\xfb \xe8\xe3\xf0\xe0 \xed\xe5 \xe7\xe0\xea\xf0\xfb\xe2\xe0\xeb\xe0\xf1\xfc." },
    } },
    { ver = "1.1-1.7", label = "v1.1 - v1.7", sub = u8"\xce\xf1\xed\xee\xe2\xe0 \xf1\xea\xf0\xe8\xef\xf2\xe0", items = {
        { "user", "b", u8"\xd1\xf2\xe0\xf2\xe8\xf1\xf2\xe8\xea\xe0 \xef\xe5\xf0\xf1\xee\xed\xe0\xe6\xe0", u8"\xc2\xea\xeb\xe0\xe4\xea\xe8 \xab\xcf\xe5\xf0\xf1\xee\xed\xe0\xe6\xbb \xe8 \xab\xc1\xee\xe9\xbb: \xe1\xe0\xeb\xe0\xed\xf1, \xeb\xe8\xf7\xed\xfb\xe5 \xe4\xe0\xed\xed\xfb\xe5, \xe1\xee\xe5\xe2\xfb\xe5 \xe1\xee\xed\xf3\xf1\xfb." },
        { "sack", "y", u8"\xc2\xea\xeb\xe0\xe4\xea\xe0 \xab\xd4\xe8\xed\xe0\xed\xf1\xfb\xbb", u8"\xc2\xf1\xe5 \xe4\xe5\xed\xfc\xe3\xe8, \xea\xf3\xf0\xf1\xfb \xe2\xe0\xeb\xfe\xf2 (AZ, BTC, AARP, VC$, ASC) \xe8 \xef\xe5\xf0\xe5\xf1\xf7\xb8\xf2 \xea\xe0\xef\xe8\xf2\xe0\xeb\xe0 \xe2 SA$." },
        { "taxes", "o", u8"\xce\xef\xeb\xe0\xf2\xe0 \xed\xe0\xeb\xee\xe3\xee\xe2 \xf7\xe5\xf0\xe5\xe7 \xf2\xe5\xeb\xe5\xf4\xee\xed", u8"\xd1\xea\xf0\xe8\xef\xf2 \xf1\xe0\xec \xef\xf0\xee\xf5\xee\xe4\xe8\xf2 \xef\xee \xec\xe5\xed\xfe \xf2\xe5\xeb\xe5\xf4\xee\xed\xe0, \xee\xef\xeb\xe0\xf2\xfb \xe7\xe0\xef\xe8\xf1\xfb\xe2\xe0\xfe\xf2\xf1\xff \xe2 \xeb\xee\xe3." },
...
PCS_CHG_COL = {
    g = { 0.35, 0.90, 0.55 }, b = { 0.45, 0.70, 1.00 }, p = { 0.75, 0.55, 1.00 },
    o = { 1.00, 0.65, 0.25 }, y = { 1.00, 0.82, 0.25 }, c = { 0.35, 0.85, 0.95 },
    r = { 1.00, 0.45, 0.55 },
}
...
function PCS_chgItems(items)
    ...
    local icoX, txtX = x0 + S(12), x0 + S(38)
    local descCol = cfg.uiLightMode and iv4(0.30, 0.32, 0.38, 1.0) or iv4(0.60, 0.65, 0.76, 1.0)
    for _, it in ipairs(items) do
        local y   = imgui.GetCursorPosY()
        local col = PCS_CHG_COL[it[2]] or { r, g, b }
        imgui.SetCursorPos(imgui.ImVec2(icoX, y + S(1)))
        imgui.TextColored(iv4(col[1], col[2], col[3], 1.0), PCS_IC[it[1]] or PCS_IC.check or "")
        imgui.SetCursorPos(imgui.ImVec2(txtX, y))
        imgui.PushTextWrapPos(imgui.GetCursorPosX() + imgui.GetContentRegionAvail().x - S(8))
        imgui.TextColored(thTxt(), it[3] or "")
        if it[4] and it[4] ~= "" then
            imgui.SetCursorPosX(txtX)
            imgui.TextColored(descCol, it[4])
        end
        imgui.PopTextWrapPos()
        imgui.Dummy(imgui.ImVec2(0, S(6)))
    end
    local p1 = imgui.GetCursorScreenPos()
    if p1.y - p0.y > S(8) then
        dl:AddRectFilled(imgui.ImVec2(p0.x + S(4), p0.y), imgui.ImVec2(p0.x + S(6), p1.y - S(6)),
            U32(iv4(r * 0.75, g * 0.75, b * 0.75, 0.55)), 1)
    end
end

-- заголовок версии (кликабельный — сворачивает/разворачивает); true = клик
function PCS_chgHeader(idx, e, isOpen)
    local r, g, b = getAcc()
    local dl  = imgui.GetWindowDrawList()
    local U32 = imgui.ColorConvertFloat4ToU32
    local p   = imgui.GetCursorScreenPos()
    local aw  = imgui.GetContentRegionAvail().x
    local h   = S(34)
    local clicked = imgui.InvisibleButton("##chgh" .. tostring(idx), imgui.ImVec2(aw, h))
    ...
    local lab = (PCS_IC.tag or "") .. "  " .. tostring(e.label or e.ver)
...
function PCS_chgView()
    ...
    local allOpen = true
    for i = 1, n do if not isOpenAt(i) then allOpen = false; break end end

    imgui.PushStyleColor(imgui.Col.Button,        iv4(0.25, 0.35, 0.55, 1))
    imgui.PushStyleColor(imgui.Col.ButtonHovered, iv4(0.35, 0.45, 0.70, 1))
    imgui.PushStyleColor(imgui.Col.ButtonActive,  iv4(0.20, 0.28, 0.45, 1))
    do local _pb = prettyBtnPush(6.0)
    if imgui.Button((PCS_IC.arrowleft or "<") .. "  " .. u8"\xcd\xe0\xe7\xe0\xe4" .. "##chgback", imgui.ImVec2(S(110), S(28))) then
        St.showChangelog = false
    end
    prettyBtnPop(_pb) end
    imgui.PopStyleColor(3)

    imgui.SameLine(0, S(12))
    imgui.TextColored(thAccBright(), (PCS_IC.history or "") .. "  " .. u8"\xc8\xf1\xf2\xee\xf0\xe8\xff \xe2\xe5\xf0\xf1\xe8\xe9")
    ...
    for i, e in ipairs(PCS_CHANGELOG) do
        ...
        if open then
            ...
            if e.sub and e.sub ~= "" then
                imgui.SetCursorPosX(imgui.GetCursorPosX() + S(12))
                imgui.TextColored(thAccBright(), e.sub)
                imgui.Dummy(imgui.ImVec2(0, S(2)))
            end
            PCS_chgItems(e.items)
        end
        imgui.Dummy(imgui.ImVec2(0, S(6)))
    end
    imgui.EndChild()
...
function drawAboutInner(h)
    if St.showChangelog then
        -- v1.9.3: красивая история версий (см. PCS_chgView выше)
        local okC, errC = PCS_GUARD.call(PCS_chgView)
        if not okC then
            St.showChangelog = false
            pcall(sampAddChatMessage, "{FF6666}[PC Stats] changelog view error: " .. tostring(errC), -1)
        end
        return
    end
    if St._resetSettScroll then imgui.SetScrollY(0) end
        ...
        aboutCard("##updcard", showProg0 and 202 or 148, function(aw, ch)
            imgui.SetWindowFontScale(aboutBaseScale)
            local U = PCS_UPDATE
            ...
            imgui.PushStyleColor(imgui.Col.Button,        iv4(0.28, 0.32, 0.42, 1.0))
            imgui.PushStyleColor(imgui.Col.ButtonHovered, iv4(0.38, 0.42, 0.55, 1.0))
            imgui.PushStyleColor(imgui.Col.ButtonActive,  iv4(0.20, 0.24, 0.32, 1.0))
            do local _pbh = prettyBtnPush(6.0)
            local histLabel = (PCS_IC.history or PCS_IC.list or "") .. "  " .. u8"\xc2\xe5\xf0\xf1\xe8\xe8" .. "##updhist"
            if imgui.Button(histLabel, imgui.ImVec2(SFtext(120), btnH)) then
                St.showChangelog = true
            end
            prettyBtnPop(_pbh) end
            imgui.PopStyleColor(3)
        ...
        -- ── v1.9.3: блок "Что нового" — новинки установленной версии +
        ...
        do
            local okW, errW = PCS_GUARD.call(function()
                ...
                imgui.PushStyleColor(imgui.Col.ButtonHovered, iv4(0.35, 0.45, 0.70, 1.0))
                imgui.PushStyleColor(imgui.Col.ButtonActive,  iv4(0.20, 0.28, 0.45, 1.0))
                do local _pbw = prettyBtnPush(6.0)
                if imgui.Button((PCS_IC.history or "") .. "  " .. u8"\xc2\xf1\xe5 \xe2\xe5\xf0\xf1\xe8\xe8 \xe8 \xf7\xf2\xee \xe2 \xed\xe8\xf5 \xe4\xee\xe1\xe0\xe2\xeb\xe5\xed\xee" .. "##chgallver", imgui.ImVec2(-1, S(32))) then
                    St.showChangelog = true
                end
                prettyBtnPop(_pbw) end
                imgui.PopStyleColor(3)
                imgui.Spacing()
            end)
            if not okW then
                pcall(sampAddChatMessage, "{FF6666}[PC Stats] whats-new block error: " .. tostring(errW), -1)
            end
        end
...
function sampev.onServerMessage(color, text)
    ...
    pcall(function()
        ...
        if t:find("%[Family%]") and (t:find("\xf1\xe5\xec\xe5\xe9\xed") or t:find("\xea\xe2\xe0\xf0\xf2")) then
            if t:find("\xed\xe0\xeb\xee\xe3") or t:find("\xea\xe2\xe0\xf0\xf2") then
                local amount = 0

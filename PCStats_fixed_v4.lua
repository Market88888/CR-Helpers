...
PCS_UPDATE = (function()
    ...
    function M.install()
        ...
        lua_thread.create(function()
            ...
            if newVer and not verLt(SCRIPT_VER, newVer) and newVer ~= normVer(SCRIPT_VER) then
                -- если на GitHub не новее — всё равно разрешаем переустановку
            end
            -- backup
            pcall(function()
            ...
            if ok and scr then
                if scr.reload then
                    ...
                    notify("\xcf\xe5\xf0\xe5\xe7\xe0\xef\xf3\xf1\xf2\xe8\xf2\xe5\x20\xf1\xea\xf0\xe8\xef\xf2\x20\xe2\xf0\xf3\xf7\xed\xf3\xfe\x20\x28F10\x20/\x20\xef\xe0\xef\xea\xe0\x20moonloader\x29", "{FFAA00}")
                end
            end
        end)
    end
